...
class _SwitchAccountPanelState extends State<SwitchAccountPanel> {
  final ValueNotifier<LoggedAccountsInAccountPanel> loggedAccounts = ValueNotifier<LoggedAccountsInAccountPanel>(LoggedAccountsInAccountPanel(usernames: [], loggedInID: null));
        ...
        child: FutureBuilder(
          ...
          builder: (context, snapshot) {
            if(snapshot.connectionState == ConnectionState.done){
              ...
              return ValueListenableBuilder(valueListenable: loggedAccounts, builder: (ctx, value, child){
