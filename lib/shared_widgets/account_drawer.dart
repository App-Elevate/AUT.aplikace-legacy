                    ...
                    children: [
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: (() => launchUrl(
                              Uri.parse(
                                  "https://github.com/tpkowastaken/autojidelna"),
                        ...
                        builder: (context) {
                          ...
                          return ElevatedButton(
                            onPressed: () async {
                              ...
                              if (releaseInfo.isAndroid &&
                                  releaseInfo.currentlyLatestVersion! &&
                                  context.mounted) {
                                Navigator.of(context).pop();
                                ...
                                ScaffoldMessenger.of(context)
                                    .showSnackBar(snackbarFunction(
                                        'nepovedlo se připojit k serverům githubu. Ověřte připojení a zkuste to znovu...',
                                        context))
                                    .closed
                                    .then((SnackBarClosedReason reason) {
                                  snackbarshown.shown = false;
