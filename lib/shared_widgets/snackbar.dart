...
SnackBar snackbarFunction(String snackBarText, BuildContext context) {
  return SnackBar(
    //light or dark theme
    backgroundColor: MediaQuery.of(context).platformBrightness == Brightness.dark ? const Color(0xff323232) : const Color(0xff323232),
    content: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Expanded(
        ...
        child: Text(
          snackBarText,
          style: TextStyle(
              color: MediaQuery.of(context).platformBrightness == Brightness.dark ? const Color.fromRGBO(255, 255, 255, 1) : const Color(0xFFFFFFFF)),
        ),
      )),
  ...
  return SnackBar(
    ...
    content: ValueListenableBuilder(
      ...
      builder: (ctx, value, child) {
        ...
        return Text(
          'Nová aktualizace se stahuje - ${(value * 100).toInt()}%',
          style: TextStyle(color: color),
        );
      },
    ),
